...
* 17.05.26 : modififactions mineurs (Traînée de pale luminosité (DM), Charmes des Êtres des Galgals (DM), Ombre venue des ténèbres (DM), Au-dessus des abysses (AS), Dame de la forêt d'Or (AS), Palantír d'Elostirion (TW et LE), Radagast (TW), Círdan (TW), Bairanax (TD))
